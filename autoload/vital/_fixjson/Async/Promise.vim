...
execute join(['function! vital#_fixjson#Async#Promise#import() abort', printf("return map({'resolve': '', 'all': '', 'race': '', 'noop': '', 'is_promise': '', 'is_available': '', 'reject': '', 'new': ''}, \"vital#_fixjson#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
...
" .finally() is just a syntax sugar of .then()
function! s:_promise_finally(...) dict abort
  let l:CB = a:0 > 0 ? a:1 : v:null
  return self.then(l:CB, l:CB)
endfunction
